...
import { clearCart, removeCartItem, addOneItem, removeOneItem } from '../redux/reducers/cart'
...
const Cart = () => {
  ...
  const {totalProductsSum, productsAdded} = useSelector(({cart}) => cart)
...
<path d="M11.6666 9.16667V14.1667" stroke="#B6B6B6" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
          ...
          <div className="content__items">
            {Object.keys(products).map((key) => {
              return <CartItem {...products[key].items[0]}  
                      key={key}
                      productCount={products[key].items.length}
          ...
          <div className="cart__bottom">
            <div className="cart__bottom-details">
              <span> Всего пицц: <b>{productsAdded} шт.</b> </span>
              <span> Сумма заказа: <b>{totalProductsSum} ₽</b> </span>
            </div>
...
<path d="M7 13L1 6.93015L6.86175 1" stroke="#D3D3D3" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        ...
        <div className="cart cart--empty">
            ...
            <p>
              Вероятней всего, вы не еще не добавили пиццу в корзину.<br />
